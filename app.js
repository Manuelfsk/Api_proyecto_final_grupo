...
// mongoose.connect("mongodb+srv://fonsecafernando88:app@cluster0.1prgpov.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0").then(
    mongoose.connect("mongodb://proyecto-fullstack-mongo-1:27017/" + config.bd).then(
...
let session = require("express-session")({
    ...
    rolling:true,
    store: mongoStore.create({mongoUrl:"mongodb://proyecto-fullstack-mongo-1:27017" + config.bd + "cookies"})
})
app.use(session)
require("./routes.js")
