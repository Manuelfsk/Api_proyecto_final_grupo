        ...
        if (respuesta.posicion == -1) {
            ...
            let mailOptions = {
                ...
                html:`<div style="background-color: #ffffff; max-width: 600px; margin: 0 auto; padding: 20px; border-radius: 10px; box-shadow: 0 4px 8px rgba(0,0,0,0.1);">
                            ...
                            <p style="text-align: center;"><a href="http://3.134.243.20:4200/activar/${post.email}/${post.azar}" style="display: inline-block; background-color: #007bff; color: #ffffff; text-decoration: none; padding: 10px 20px; border-radius: 5px;">Completar registro</a></p>
